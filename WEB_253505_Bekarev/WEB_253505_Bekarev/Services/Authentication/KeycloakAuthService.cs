...
namespace WEB_253505_Bekarev.Services.Authentication
{
    public class KeycloakAuthService : IAuthService
    {
        ...
        public KeycloakAuthService(HttpClient httpClient, IOptions<KeycloakData> options, IFileService fileService, ITokenAccessor tokenAccessor, IHttpContextAccessor httpContextAccessor)
        {
